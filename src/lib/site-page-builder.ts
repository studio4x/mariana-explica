...
export function composeManagedPageCss(additionalCss?: string | null) {
  ...
  const themeCss = `
.me-managed-page-root h1,
.me-home-shell h1,
.me-about-shell h1,
.me-explicacoes-shell h1,
.me-materiais-shell h1,
.me-support-shell h1,
.me-legal-shell h1 {
  font-family: var(--site-h1-font-family) !important;
  font-size: var(--site-h1-font-size) !important;
  font-weight: var(--site-h1-font-weight) !important;
  line-height: var(--site-h1-line-height) !important;
  letter-spacing: var(--site-h1-letter-spacing) !important;
  text-transform: var(--site-h1-text-transform) !important;
}

.me-managed-page-root h2,
.me-home-shell h2,
.me-about-shell h2,
.me-explicacoes-shell h2,
.me-materiais-shell h2,
.me-support-shell h2,
.me-legal-shell h2 {
  font-family: var(--site-h2-font-family) !important;
  font-size: var(--site-h2-font-size) !important;
  font-weight: var(--site-h2-font-weight) !important;
  line-height: var(--site-h2-line-height) !important;
  letter-spacing: var(--site-h2-letter-spacing) !important;
  text-transform: var(--site-h2-text-transform) !important;
}

.me-managed-page-root h3,
.me-home-shell h3,
.me-about-shell h3,
.me-explicacoes-shell h3,
.me-materiais-shell h3,
.me-support-shell h3,
.me-legal-shell h3 {
  font-family: var(--site-h3-font-family) !important;
  font-size: var(--site-h3-font-size) !important;
  font-weight: var(--site-h3-font-weight) !important;
  line-height: var(--site-h3-line-height) !important;
  letter-spacing: var(--site-h3-letter-spacing) !important;
  text-transform: var(--site-h3-text-transform) !important;
}

.me-managed-page-root h4,
.me-home-shell h4,
.me-about-shell h4,
.me-explicacoes-shell h4,
.me-materiais-shell h4,
.me-support-shell h4,
.me-legal-shell h4 {
  font-family: var(--site-h4-font-family) !important;
  font-size: var(--site-h4-font-size) !important;
  font-weight: var(--site-h4-font-weight) !important;
  line-height: var(--site-h4-line-height) !important;
  letter-spacing: var(--site-h4-letter-spacing) !important;
  text-transform: var(--site-h4-text-transform) !important;
}

.me-managed-page-root h5,
.me-home-shell h5,
.me-about-shell h5,
.me-explicacoes-shell h5,
.me-materiais-shell h5,
.me-support-shell h5,
.me-legal-shell h5 {
  font-family: var(--site-h5-font-family) !important;
  font-size: var(--site-h5-font-size) !important;
  font-weight: var(--site-h5-font-weight) !important;
  line-height: var(--site-h5-line-height) !important;
  letter-spacing: var(--site-h5-letter-spacing) !important;
  text-transform: var(--site-h5-text-transform) !important;
}

.me-managed-page-root h6,
.me-home-shell h6,
.me-about-shell h6,
.me-explicacoes-shell h6,
.me-materiais-shell h6,
.me-support-shell h6,
.me-legal-shell h6 {
  font-family: var(--site-h6-font-family) !important;
  font-size: var(--site-h6-font-size) !important;
  font-weight: var(--site-h6-font-weight) !important;
  line-height: var(--site-h6-line-height) !important;
  letter-spacing: var(--site-h6-letter-spacing) !important;
  text-transform: var(--site-h6-text-transform) !important;
}

.me-managed-page-root p,
.me-home-shell p,
.me-about-shell p,
.me-explicacoes-shell p,
.me-materiais-shell p,
.me-support-shell p,
.me-legal-shell p,
.me-legal-shell p {
  font-family: var(--site-paragraph-font-family) !important;
  font-size: var(--site-paragraph-font-size) !important;
  font-weight: var(--site-paragraph-font-weight) !important;
  line-height: var(--site-paragraph-line-height) !important;
  letter-spacing: var(--site-paragraph-letter-spacing) !important;
  text-transform: var(--site-paragraph-text-transform) !important;
}

.me-managed-page-root li,
.me-home-shell li,
.me-about-shell li,
.me-explicacoes-shell li,
.me-materiais-shell li,
.me-support-shell li,
.me-legal-shell li {
  font-family: var(--site-list-item-font-family) !important;
  font-size: var(--site-list-item-font-size) !important;
  font-weight: var(--site-list-item-font-weight) !important;
  line-height: var(--site-list-item-line-height) !important;
  letter-spacing: var(--site-list-item-letter-spacing) !important;
  text-transform: var(--site-list-item-text-transform) !important;
}
  `.trim()
