...
export const APP_DESCRIPTION =
  "Materiais claros e preparação para exame com qualidade."
...
export const ROUTES = {
  ...
  STUDENT_MESSAGES: "/aluno/suporte",
  ...
  DASHBOARD_MESSAGES: "/aluno/suporte",
  DASHBOARD_PROFILE: "/aluno/perfil",
  ADMIN: "/admin",
  ADMIN_OPERATIONS: "/admin/configuracoes?tab=operacoes",
  ADMIN_PAYMENTS: "/admin/pagamentos/historico",
  ADMIN_PAYMENTS_HISTORY: "/admin/pagamentos/historico",
  ADMIN_PAYMENTS_SETTINGS: "/admin/pagamentos/configuracoes",
  ADMIN_MOLONI: "/admin/integracoes/moloni",
  ADMIN_MOLONI_SETTINGS: "/admin/integracoes/moloni/configuracao",
