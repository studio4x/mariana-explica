...
export const VISUAL_EDITOR_PAGE_DEFINITIONS: VisualEditorPageDefinition[] = [
  {
    ...
    fields: [
      ...
      { key: "hero.primaryCta", label: "Botao principal", kind: "link" },
      { key: "hero.secondaryCta", label: "Link secundario", kind: "link" },
      ...
      { key: "supportCta.primaryCta", label: "Botao do bloco final", kind: "link" },
      { key: "supportCta.secondaryCta", label: "Link extra do bloco final", kind: "link" },
    ],
  },
  {
    pageKey: "materials",
    ...
    fields: [
      ...
      { key: "hero.lead", label: "Paragrafo principal", kind: "textarea" },
      { key: "hero.primaryCta", label: "Botao principal", kind: "link" },
      { key: "catalogHelpCta", label: "Botao de apoio ao catalogo", kind: "link" },
      { key: "supportCta.title", label: "Titulo do bloco final", kind: "text" },
      { key: "supportCta.lead", label: "Paragrafo do bloco final", kind: "textarea" },
      { key: "supportCta.primaryCta", label: "Botao do bloco final", kind: "link" },
      { key: "supportCta.secondaryCta", label: "Link extra do bloco final", kind: "link" },
      { key: "faq.eyebrow", label: "Legenda da FAQ", kind: "text" },
      { key: "faq.title", label: "Titulo da FAQ", kind: "text" },
    ],
  },
]
