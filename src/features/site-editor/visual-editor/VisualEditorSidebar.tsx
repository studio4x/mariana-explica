      ...
      <div className={panelClassName}>
        ...
        >
          ...
          <div className="mt-4 flex flex-wrap items-center gap-2">
            ...
            {isFixed ? (
              <span className={cn("rounded-full px-3 py-1 text-[11px] font-semibold", isLocked ? "bg-slate-100 text-slate-600" : "bg-sky-50 text-sky-700")}>
            ...
            <div className="mt-4 rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm leading-6 text-slate-600">
              ...
              <p className="mt-1">
                {isLocked
                  ...
                  : "Clique em um elemento editavel para selecionar o campo e editar em tempo real."}
              </p>
            </div>
          ) : null}
        </div>
