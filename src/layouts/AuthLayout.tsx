...
import { CookieConsentBanner, Footer, Navbar, ScrollToTop, SiteBrandingManager, SiteTrackingManager } from "@/components/common"
        ...
        <div className="container grid min-h-[calc(100vh-8rem)] items-center gap-10 py-10 lg:grid-cols-[0.95fr_1.05fr]">
          <section className="hidden rounded-[2rem] border border-white/70 bg-[linear-gradient(135deg,#242742_0%,#365d87_100%)] p-10 text-white shadow-xl lg:block">
            ...
            <p className="mt-5 max-w-xl text-base leading-8 text-white/80">
              Compra, acesso e acompanhamento no mesmo ambiente, com uma experiência clara para quem quer aprender sem perder tempo.
            </p>
            <div className="mt-10 grid gap-4 sm:grid-cols-3">
              {[
                { icon: ShieldCheck, label: "Conta protegida" },
                { icon: Sparkles, label: "Conteúdo organizado" },
