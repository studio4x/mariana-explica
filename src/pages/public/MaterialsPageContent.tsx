...
import {
  ...
  type MaterialsVisualEditorDocument,
        ...
        <SiteContentScope title="Hero principal" description="Legenda, título, texto e CTA inicial">
          <header className="mx-auto max-w-4xl text-center">
            <EditableText
              ...
              className="text-xs font-black uppercase tracking-[0.32em] text-[#4e6880]"
            />
            <EditableText
              fieldKey="hero.title"
              as="h1"
              fallback={hero.title}
              className="mt-4 font-display text-4xl font-bold leading-[1.05] tracking-[-0.03em] text-[#1b2644] md:text-6xl"
            />
            <EditableText
              fieldKey="hero.lead"
              as="p"
              fallback={hero.lead}
              className="mx-auto mt-5 max-w-3xl text-base leading-8 text-[#41586c] md:text-lg"
            />
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              <EditableButton
                ...
                className="rounded-full bg-[#28304f] px-6 text-white hover:bg-[#1d2340]"
              />
            </div>
          </header>
        </SiteContentScope>

        <SiteContentScope title="Catálogo" description="Filtros, pesquisa e listagem dos materiais">
          <section id="catalogo" className="mx-auto mt-10 max-w-6xl">
            <div className="rounded-[2rem] border border-white/80 bg-white/50 p-5 shadow-[0_24px_70px_rgba(19,54,75,0.08)] backdrop-blur">
              ...
              <div className="mt-5 flex flex-col items-center justify-between gap-3 border-t border-white/70 pt-4 text-center md:flex-row md:text-left">
                ...
                <EditableButton
                  fieldKey="catalogHelpCta"
                  fallback={catalogHelpCta}
                  variant="secondary"
                  className="w-full rounded-full border-[#c5d7e2] bg-white/90 md:w-auto"
                />
              </div>
            </div>
          </section>
            ...
            <EmptyState
              ...
              message={
                search.trim()
                  ...
                  : "Ainda não há materiais publicados para mostrar."
              }
            />
          ) : null}
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              >
                ...
                <EditableText
                  ...
                  className="mt-3 font-display text-3xl font-bold tracking-[-0.02em] text-[#1b2644]"
                />
                <EditableText
                  fieldKey="supportCta.lead"
                  as="p"
                  fallback={supportCta.lead}
                  className="mt-4 max-w-xl text-base leading-8 text-[#41586c]"
                />
              ...
              <div className="rounded-[1.75rem] border border-white/70 bg-white/55 p-8 shadow-[0_24px_70px_rgba(19,54,75,0.08)] backdrop-blur">
                <EditableText
                  ...
                  as="p"
                  fallback={faq.eyebrow}
                  className="text-xs font-black uppercase tracking-[0.28em] text-[#4e6880]"
                />
                <EditableText
                  fieldKey="faq.title"
                  as="h2"
