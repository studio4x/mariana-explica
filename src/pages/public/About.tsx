      ...
      <div className="mx-auto max-w-[1200px] px-6">
        ...
        <div className="mt-12 grid items-center gap-8 md:mt-14 md:grid-cols-2 md:gap-12">
          <div className="flex min-h-[260px] items-center justify-center rounded bg-[#e8f0f4] p-8 md:min-h-[430px]">
            <p className="font-display text-4xl font-bold text-[#1f2237] md:text-5xl">(foto)</p>
          </div>

          <div className="space-y-9 text-center md:text-left">
            <p className="font-display text-3xl font-bold leading-[1.3] text-[#0f122c] md:text-4xl">
              Ola! Eu sou a Mariana, fundadora do Mariana Explica e, atualmente, estudante de Filosofia na FLUP.
            </p>

            <p className="font-display text-[2rem] font-bold leading-[1.35] text-[#0f122c] md:text-4xl">
        ...
        <div className="mt-16 md:mt-24">
          <div className="mx-auto max-w-[980px] text-center">
            <h2 className="font-display text-4xl font-bold leading-tight text-[#0f122c] md:text-5xl">
          ...
          <div className="mt-10 grid gap-6 md:mt-12 md:grid-cols-2 md:gap-8">
            <article className="rounded bg-[#e8f0f4] px-8 py-9 md:px-10 md:py-11">
              <p className="font-display text-[2rem] font-bold leading-[1.45] text-[#0f122c] md:text-[2.2rem]">
            ...
            <article className="rounded bg-[#e8f0f4] px-8 py-9 md:px-10 md:py-11">
              <p className="text-center font-display text-[2rem] font-bold leading-[1.45] text-[#0f122c] md:text-[2.2rem]">
          ...
          <div className="mt-10 space-y-8 md:mt-12 md:space-y-10">
            <div className="grid gap-4 md:grid-cols-[minmax(0,1fr)_220px] md:items-center">
              <article className="rounded bg-[#e8f0f4] px-6 py-6 md:px-10 md:py-7">
                <p className="text-center font-display text-[1.85rem] font-bold leading-[1.35] text-[#0f122c] md:text-[2rem]">
              ...
              <div className="mx-auto flex w-full max-w-[220px] items-center justify-center rounded-[18px] bg-[#9aa8bb] px-5 py-4 md:mx-0">
                <p className="text-center font-display text-[2rem] font-bold leading-tight text-[#0f122c] md:text-[2.05rem]">
                  Rigor Academico
                </p>
              </div>
            </div>
