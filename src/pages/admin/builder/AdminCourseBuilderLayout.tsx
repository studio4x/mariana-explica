    ...
    try {
      ...
      for (const assessmentData of moduleAssessments) {
        ...
        await createAssessment.mutateAsync({
          ...
          requiresPassingScore: assessmentData.requires_passing_score,
      ...
      if (importedFinalAssessment) {
        ...
        if (existingFinal) {
          await updateAssessment.mutateAsync({
            ...
            requiresPassingScore: importedFinalAssessment.requires_passing_score,
    ...
    <div className="relative flex h-screen w-full flex-col overflow-hidden bg-slate-50 text-slate-900">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="relative flex-1 h-full w-full overflow-y-auto border-t border-slate-100 bg-slate-50/50 shadow-inner">
          <div className="relative flex min-h-full flex-col p-4 pb-24 sm:px-6 sm:py-6 lg:px-8 lg:py-7">
            <div className="flex-1">
              <Outlet context={context} />
            </div>

            <div className="mt-auto flex justify-start pt-6">
              <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/95 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.22em] text-slate-500 shadow-sm backdrop-blur">
