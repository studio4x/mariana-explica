  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleCreate} className="rounded-[1.75rem] border bg-white p-6 shadow-sm">
        <h2 className="font-display text-2xl font-bold text-slate-950">Criar utilizador</h2>
                    ...
                    <td className="py-4 pr-4">
                      <div className="space-y-2">
                        ...
                        <select
                          ...
                          className="h-10 w-full rounded-xl border bg-slate-50 px-3 text-sm outline-none focus:border-slate-400 focus:bg-white"
                        >
