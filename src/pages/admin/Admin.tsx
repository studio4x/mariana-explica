      ...
      <section className="rounded-[1.75rem] border bg-white p-6 shadow-sm">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="max-w-2xl space-y-3">
            ...
            <h2 className="font-display text-2xl font-bold text-slate-950">Painel de pagamentos separado</h2>
            <p className="text-sm leading-7 text-slate-600">
              A configuração operacional de Stripe, Vercel e webhooks ficou numa página própria do admin para manter a
              visão geral limpa e a operação mais fácil de consultar.
            </p>
          </div>
          <Button asChild variant="outline" className="rounded-full">
            <Link to={ROUTES.ADMIN_PAYMENTS}>Abrir pagamentos</Link>
          </Button>
        </div>
      </section>
