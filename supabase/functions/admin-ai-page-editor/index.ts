...
function buildUnderstandingSystemPrompt(config: ReturnType<typeof normalizeConfigValue>, currentTitle: string, currentPath: string) {
  return [
    ...
    "\"entre o cabecalho e a primeira secao\", \"faixa branca entre o menu e a primeira secao\", \"espaco em branco no inicio da pagina\" e \"espaco acima da primeira secao\" tambem significam spacing externo antes da primeira secao, nao edicao textual do cabecalho.",
    "\"entre a ultima secao da pagina e o rodape\", \"faixa branca acima do rodape\", \"espaco antes do rodape\" e \"aproximar a ultima secao do rodape\" significam spacing visual no fim da pagina, nao edicao textual do rodape.",
    "Se o historico anterior dizia para remover espaco em branco e a resposta atual diz apenas onde fica, consolida a intencao com o historico em vez de analisar a resposta isoladamente.",
    ...
    "Exemplo 11: historico='remova esse espaco em branco' e resposta='Esta entre a ultima secao da pagina e o rodape' -> understanding_summary='remover o espaco em branco entre a ultima secao da pagina e o rodape, mantendo o rodape igual'.",
    "Exemplo 12: pedido='quero mudar o texto do rodape' -> understanding_summary='mudar o texto do rodape'.",
...
function buildUnderstandingUserPrompt(input: {
  ...
  return [
    ...
    "Distincao importante: antes/acima/fora da primeira secao e entre o cabecalho ou menu e a primeira secao = espaco externo. Topo da primeira secao = topo da area da secao. Dentro da primeira secao = espaco interno.",
    "",
