...
- [ ] ADM-041 Bloco de vídeo da aula permite upload automático ao selecionar o ficheiro, exclusão do vídeo e pré-visualização correta na aula e no construtor.
