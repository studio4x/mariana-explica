Considere o AGENTS.md.

Use o arquivo:
docs/CHECKLIST_FUNCIONALIDADES_SITE.md
...
- Teste em produção: https://www.mariana-explica.pt/
- Marque como [OK] somente quando o teste realmente passar
